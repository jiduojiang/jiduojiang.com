...
/learning/{slug}/              ← one folder per learning project
...
There are three project categories. On the homepage they appear in this order:

1. **learning** — anything aimed at practice or study (math drills, spelling, flashcards…)
2. **games** — playable games
3. **tools** — small utilities (timer, calculator, color picker…)
